...
export default function Hero() {
  const greetings = ["Hello,", "नमस्ते,", "Bonjour,", "Hola,", "Ciao,", "Konnichiwa,"];
...
const profile = {
    name: 'Aditya Kumar,
    title: 'Developer | Analyst | Problem Solver',
    skills: [
        'React', 'NextJS', 'NodeJS', 'Javascript',
        'MySQL', 'MongoDB', 'Docker', 'AWS', 'TypeScript',
        'Laravel', 'Git', 'Linux', 'Discord Development'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true, 
  ...
  <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-tight">
    <SparklesText text={greetings[index]} />
  ...
  <div className="absolute -z-10 top-1/2 -translate-y-1/2 left-1/4 w-24 sm:w-32 h-24 sm:h-32 bg-blue-500/20 rounded-full blur-2xl animate-pulse"></div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                {/* View Projects Button */}
                  ...
                  <div className="flex items-center space-x-4">
                    <a href="https://www.linkedin.com/in/aditya-kumar-965640291/"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Visit Aditya Kumar's LinkedIn profile"
                    className="bg-pink-500/10 p-3 rounded-lg hover:bg-pink-500/20 transition">
                      ...
                      <div className="flex items-center space-x-4">
                        <a
                        href="https://github.com/Ad1tyaKr"
                        target="_blank"
                        rel="noopener noreferrer"
                        ...
                        <FaGithub className="w-6 h-6 text-purple-500" />
                          ...
                          <div className="flex items-center space-x-4">
                        <a
                        href="https://x.com/Adityakr3579"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="Visit Aditya Kumar's Twitter profile"
                        className="bg-pink-500/10 p-3 rounded-lg hover:bg-pink-500/20 transition">
                        <RiTwitterXLine className="w-6 h-6 text-black-500" />
                        </a>
                          </div>

                {/* Contact Button */}
                <a
                  href="https://drive.google.com/file/d/1pqRRk5zuWN_lzB1PsbVt8AEA6i1CV-LN/view?usp=drive_link"
                  target="_blank"
                        rel="noopener noreferrer"
              ...
              {/* Floating badges */}
              <div className="hidden lg:block absolute left-[8.5rem] top-[2.3rem] animate-float-slow">
