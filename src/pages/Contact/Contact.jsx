              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">adityakr3579@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">+91-8447708208</p>
                  </div>
              </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  className="bg-pink-500/10 p-3 rounded-lg">
                    ...
                    <a href="https://github.com/Ad1tyaKr"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-pink-500/10 p-3 rounded-lg">
                    <FaGithub className="w-6 h-6 text-pink-400"/>
                    </a>

                    <a href="https://x.com/Adityakr3579"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-pink-500/10 p-3 rounded-lg">
                    <RiTwitterXLine className="w-6 h-6 text-pink-400"/>
                    </a>

                    <a href="https://www.instagram.com/adityakr_35"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-pink-500/10 p-3 rounded-lg">
